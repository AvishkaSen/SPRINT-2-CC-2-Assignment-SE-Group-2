...
<body>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $query = $adsModel -> query("SELECT * FROM adverts WHERE approved = 'No'"); 
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('Postings/jobDetailsPage/'.$row -> id)?>" class="btn btn-outline-primary float-end btn-sm">View</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url('Admin/approveAd/'.$row -> id)?>" class="btn btn-outline-success float-end btn-sm">Approve</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url('Admin/deleteAd/'.$row -> id)?>" class="btn btn-outline-danger float-end btn-sm">Delete</a>
                                        </td>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <div class="card border border-dark mb-5 mt-3">
                    <div class="card-header">
                        <h4>Approved Ads</h4>
                    </div>
                    <div class="card-body">
